...
public class ViaAppiaExample {
    ...
    private static ViaAppiaInterfaceWindow examplePanel;
    ...
    private static ViaAppiaGLEventListener exampleGLEventListener;
    ...
    public ViaAppiaExample() {
        // Create the Swing interface elements
        examplePanel = new ViaAppiaInterfaceWindow();

        // Create the custom GLEventListener
        exampleGLEventListener = new ViaAppiaGLEventListener();

        // Create the default ESight OpenGL window.
        new NeonNewtWindow(true, ViaAppiaInputHandler.getInstance(), exampleGLEventListener,
                settings.getDefaultScreenWidth(), settings.getDefaultScreenHeight(),
                "Graphs - example Visualization Tool");
